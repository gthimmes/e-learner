...
const courses = await db.course.deleteMany({
  where: { OR: [{ title: { startsWith: "E2E Course" } }, { title: { startsWith: "Discover Course" } }, { title: { startsWith: "Paid Course" } }, { title: { startsWith: "Assess Course" } }, { title: { startsWith: "Engage Course" } }, { slug: { startsWith: "e2e-" } }, { slug: { startsWith: "disc-" } }, { slug: { startsWith: "paid-" } }] },
});
